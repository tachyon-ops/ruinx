// Macroquad
// check here: https://github.com/not-fl3/macroquad/blob/master/src/file.rs
...
impl FileError {
    pub fn new(kind: fs::Error, path: &str) -> Self {
        Self {
            kind,
            path: path.to_string(),
        }
...
pub fn get_path(path: &str) -> String {
    ...
    let path = if let Some(ref pc_assets) = crate::get_assets_context().pc_assets_folder {
